	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">调度员工号：</div>
					<el-input class="list_inp"
						 v-model="registerForm.diaoduyuangonghao" 
						 placeholder="请输入调度员工号"
						 type="text"
						/>
				</div>
				<div class="list_item">
					<div class="list_label">调度员密码：</div>
					<el-input class="list_inp"
						 v-model="registerForm.diaoduyuanmima" 
						 placeholder="请输入调度员密码"
						 type="password"
						 />
				</div>
				<div class="list_item">
					<div class="list_label">确认调度员密码：</div>
					<el-input class="list_inp" v-model="registerForm.diaoduyuanmima2" type="password" placeholder="请输入确认调度员密码" />
				</div>
				<div class="list_item">
					<div class="list_label">调度员姓名：</div>
					<el-input class="list_inp"
						 v-model="registerForm.diaoduyuanxingming" 
...
<script setup>
	...
	const handleRegister = () => {
		...
		if(registerForm.value.diaoduyuanmima!=registerForm.value.diaoduyuanmima2){
