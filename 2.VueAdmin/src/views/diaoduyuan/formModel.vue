	...
	<div>
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					<el-col :span="12">
						<el-form-item label="调度员工号" prop="diaoduyuangonghao">
							<el-input class="list_inp" v-model="form.diaoduyuangonghao" placeholder="调度员工号"
								type="text" :readonly="!isAdd||disabledForm.diaoduyuangonghao?true:false" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="调度员密码" prop="diaoduyuanmima">
							<el-input class="list_inp" v-model="form.diaoduyuanmima" placeholder="调度员密码"
								type="password" :readonly="!isAdd||disabledForm.diaoduyuanmima?true:false" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="调度员姓名" prop="diaoduyuanxingming">
							<el-input class="list_inp" v-model="form.diaoduyuanxingming" placeholder="调度员姓名"
								 type="text" 								:readonly="!isAdd||disabledForm.diaoduyuanxingming?true:false" />
						</el-form-item>
					</el-col>
...
<script setup>
	...
	//基础信息
	const tableName = 'diaoduyuan'
	const formName = '调度员'
	//基础信息
	//form表单
	const form = ref({})
	const disabledForm = ref({
		diaoduyuangonghao : false,
		diaoduyuanmima : false,
		diaoduyuanxingming : false,
		touxiang : false,
		lianxifangshi : false,
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			// getInfo()
			for(let x in row){
				if(x=='diaoduyuangonghao'){
					form.value.diaoduyuangonghao = row[x];
					disabledForm.value.diaoduyuangonghao = true;
					continue;
				}
				if(x=='diaoduyuanmima'){
					form.value.diaoduyuanmima = row[x];
					disabledForm.value.diaoduyuanmima = true;
					continue;
				}
				if(x=='diaoduyuanxingming'){
					form.value.diaoduyuanxingming = row[x];
					disabledForm.value.diaoduyuanxingming = true;
					continue;
				}
				if(x=='touxiang'){
