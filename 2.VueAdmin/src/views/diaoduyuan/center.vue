				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="调度员工号" prop="diaoduyuangonghao">
							<el-input class="list_inp" v-model="user.diaoduyuangonghao" readonly placeholder="调度员工号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="调度员密码" prop="diaoduyuanmima">
							<el-input class="list_inp" v-model="user.diaoduyuanmima" readonly placeholder="调度员密码" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="调度员姓名" prop="diaoduyuanxingming">
							<el-input class="list_inp" v-model="user.diaoduyuanxingming"  placeholder="调度员姓名" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="diaoduyuantouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
<script setup>
	...
	const tableName = ref('diaoduyuan')
	const user = ref({})
	const init = () => {
	}
	const diaoduyuantouxiangUploadSuccess=(fileUrls)=> {
