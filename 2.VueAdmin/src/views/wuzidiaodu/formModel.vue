				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="调度编号" prop="diaodubianhao">
							<el-input class="list_inp" v-model="form.diaodubianhao" :readonly="true" placeholder="调度编号" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="发往时间" prop="fawangshijian">
							<el-date-picker
								class="list_date"
								v-model="form.fawangshijian"
								format="YYYY 年 MM 月 DD 日"
								value-format="YYYY-MM-DD"
								type="datetime"
								:readonly="!isAdd||disabledForm.fawangshijian?true:false"
								placeholder="请选择发往时间" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='fawangshijian'){
					form.value.fawangshijian = row[x];
					disabledForm.value.fawangshijian = true;
					continue;
				}
				if(x=='yonghuzhanghao'){
